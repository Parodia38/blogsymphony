...
class __TwigTemplate_f488f770cb640470701706601f44edfc1fb4c0ae24f12775163ccc8860d27ca1 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "admin/user/_form.html.twig", ["button_label" => "Modifier"]);
        echo "
...
{% block content %}
    ...
    {{ include('admin/user/_form.html.twig', {'button_label': 'Modifier'}) }}

    <a href=\"{{ path('user_index') }}\" class=\"btn btn-link\">Retour à la liste</a>

    {{ include('admin/user/_delete_form.html.twig') }}
{% endblock %}
", "admin/user/edit.html.twig", "/Users/arnaudbassey/Documents/DWWM/Initiation symphony/dwm-blog-19/templates/admin/user/edit.html.twig");
    }
}
