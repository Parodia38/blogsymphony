...
class __TwigTemplate_98d13f177e9cf1154e882513cd6591bc4789c64f54e7496e49e97715cba4ca3e extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    {{ include('admin/category/_form.html.twig', {'button_label': 'Modifier'}) }}

    <p class=\"py-2\">
        <a href=\"{{ path('category_index') }}\" class=\"btn btn-outline-primary\">Retour à la liste</a>
    </p>

    {{ include('admin/category/_delete_form.html.twig') }}
{% endblock %}
", "admin/category/edit.html.twig", "/Users/arnaudbassey/Documents/DWWM/Initiation symphony/dwm-blog-19/templates/admin/category/edit.html.twig");
    }
}
